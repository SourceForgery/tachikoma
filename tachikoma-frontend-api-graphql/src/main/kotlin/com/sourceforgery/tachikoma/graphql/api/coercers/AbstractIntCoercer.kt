...
abstract class AbstractIntCoercer<I : Any> : GraphqlCoercer<I, BigInteger> {
    override fun parseValue(input: Any, graphQLContext: GraphQLContext, locale: Locale): I = try {
    ...
    override fun parseLiteral(input: Value<*>, variables: CoercedVariables, graphQLContext: GraphQLContext, locale: Locale): I = try {
    ...
    override fun serialize(dataFetcherResult: Any, graphQLContext: GraphQLContext, locale: Locale): BigInteger? =
        toInt(dataFetcherResult as I)
}
