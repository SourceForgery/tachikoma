...
internal constructor(private val input: String) {
    ...
    private fun parseComponentWithIP(delimiters: String, mayEnd: Boolean): String? {
     ...
     */
    private fun parseComponent(delimiters: String?, mayEnd: Boolean, isIp: Boolean = false): String? {
